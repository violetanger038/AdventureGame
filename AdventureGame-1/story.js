...
const thguard =" ";
const askguard=" ";
const rfp ="You run away darting down the hall. You hear footsteps coming up behind you. You desperatelytry to find a hiding place. Just then you find a large crack in the hall big enough for you to hide in. You hold your breath as they rush past you. Once the footsteps disappear, you ease your self out of the crack. ";
const YdtG ="You don’t trust the guard. You run down a random hallway. As you run your foot lands on a pressure tile. Part of the ceiling falls down on top of you. Luckily you had time to catch it before it hit your head.";
        ...
        switch (i) {
            ...
            case 2:// you decided to break door
                ...
                if (choice ==false){
                    ...
                    await captureInput(null,null,null,rfp)
                    i=3
                }
                break;
            case 3:// you decide to ask the guard
                ...
                break;
            case 4:// you decided to figurr the lock out or you decide to run
            ...
            case 6://you stay
                ...
                break;
            case 7:// you decide to save the guard
                ...
                break;
            case 8:// you dont save guard
                await captureInput(null,null,null,YdtG)
